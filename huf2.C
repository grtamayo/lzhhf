/*
	...
	Date:       June 22-24, 2004, 9/18/2024
...
int hmin = -1;
unsigned int hsymbol_bit_size = HMAX_BITS;
...
here. the symbol node's parent would suffice as an argument passed 
to the recursive call inside the function.
*/
